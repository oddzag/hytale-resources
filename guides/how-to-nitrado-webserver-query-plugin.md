...
Nitrado has created a [Webserver](https://github.com/nitrado/hytale-plugin-webserver) and [Query](https://github.com/nitrado/hytale-plugin-query) plugin that allows for web-based interaction with your Hytale server. This is being setup on a dedicated server.
